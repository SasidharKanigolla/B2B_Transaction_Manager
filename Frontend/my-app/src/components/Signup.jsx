      ...
      <div className="w-[60%] flex flex-col items-center">
        ...
        <form onSubmit={signup} className="w-full">
          <div className="mb-5 w-full">
            <label htmlFor="buss_name" className="flex font-semibold text-xl">
          ...
          <div className="mb-5 w-full">
            <label htmlFor="password" className="flex font-semibold text-xl">
          ...
          <div className="mb-5 w-full">
            <label htmlFor="trans_pass" className="flex font-semibold text-xl">
              Transaction Password
              <p className="font-bold text-red-600">(CANNOT BE CHANGED LATER)</p>
